...
class PersonViewState extends State<PersonView> {
  ...
  Widget build(BuildContext context) {
    ...
    if (GlobalsArgs.actualRoute == "/element/person/") {
          ...
          slivers: <Widget>[
            SliverPersistentHeader(
              delegate: CustomSliverAppBar(
                expandedHeight: 175, 
                heroTag: heroTag,
                banierePath: _preLoadData["known_for"][0]["backdrop_path"], //Most known movie or serie backdrop
                posterPath: _preLoadData["profile_path"],
                movieTitle: _preLoadData["name"], 
              ),
              pinned: true,
            ),
          ],
