...
import 'package:Videotheque/controllers/person_controller/tag_controller.dart';
import 'package:Videotheque/controllers/person_controller/person_controller.dart';

class TagView extends StatelessWidget {
  ElementsTypes type;
  List tags;
  PersonController parentController;
            ...
            child: Wrap(
              ...
              children: List<Widget>.generate(type == ElementsTypes.GenreTags ? controller.getTagsLength()+1 : controller.getTagsLength(), (int index) {
                if (controller.getTagsLength() == 0 && type == ElementsTypes.GenreTags) return ActionChip(
                  ...
                  label: Icon(Icons.edit, color: PersonView.baseColor),
                  onPressed: () => controller.onEditTagsTapped(),
                  shape: StadiumBorder(side: BorderSide(color: PersonView.baseColor, width: 1.5)),
                );
                  ...
                  avatar: CircleAvatar(
                    backgroundColor: Colors.transparent,
                    child: Icon(type == ElementsTypes.GenreTags ? Icons.label_outline : Icons.info_outline, color: PersonView.baseColor),
                  ),
