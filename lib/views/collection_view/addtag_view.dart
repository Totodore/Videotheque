            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                      ...
                      children: List<Widget>.generate(controller.chips.length, (int index) {
                        ...
                        return ActionChip(
                          ...
                          avatar: CircleAvatar(
                            ...
                            child: Icon(Icons.close, color: CollectionView.baseColor),
                          ),
                  ...
                  DividerComponent(CollectionView.baseColor),
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
                    child: Text("Rajoutez de nouveaux tags pour identifier les collections ajoutées ! : ",
                  ...
                  Padding(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        labelStyle: TextStyle(color: CollectionView.baseColor),
