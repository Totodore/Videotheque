...
import 'package:Videotheque/controllers/collection_controller/carrousel_controller.dart';

class CarrouselView extends StatelessWidget {
  List dataCarrousel;

  CarrouselView(this.dataCarrousel);
  
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => CarrouselController(context, dataCarrousel),
                        ...
                        children: <Widget>[
                          Hero(
                            ...
                            child: ProgressiveImage(
                              ...
                              thumbnail: Utils.fetchImage(controller.getImageElement(index), ImageTypes.Poster, true),
                              image: Utils.fetchImage(controller.getImageElement(index), ImageTypes.Poster),
                              width: 120,
                              height: 150,
