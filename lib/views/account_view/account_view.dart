          ...
          return Scaffold(
            appBar: PreferredSize(
              ...
              child: AppBar(
                ...
                actions: [
                  IconButton(icon: Icon(Icons.settings, color: Colors.white), onPressed: controller.openSettings)
                ],
              ),
            ),
            bottomNavigationBar: AnimatedCrossFade(
              ...
              crossFadeState: controller.askCoffeeState == States.Added ? CrossFadeState.showFirst : CrossFadeState.showSecond,
              firstChild: Container(
                ...
                child: FlatButton.icon(
                  onPressed: controller.donateBtn, 
                  icon: Icon(Icons.local_cafe, color: Colors.white, size: 50), 
                  padding: EdgeInsets.symmetric(vertical: 10, horizontal: 12),
                  label: Flexible(
                    child: Text(
                      "Si vous aimez Vidéothèque n'hésitez pas à me supporter en m'offrant un café :). Cela me permettra de continuer cette application gratuite sans y mettre de pubs.",
