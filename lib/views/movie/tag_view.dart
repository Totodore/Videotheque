...
import 'package:Videotheque/controllers/movie/tag_controller.dart';
import 'package:Videotheque/controllers/movie/movie_controller.dart';
              ...
              children: List<Widget>.generate(type == ElementsTypes.GenreTags && isAdded ? controller.getTagsLength()+1 : controller.getTagsLength(), (int index) {
                if (controller.getTagsLength() == index) 
                  return ActionChip(
                    ...
                    shape: StadiumBorder(side: BorderSide(color: GlobalsColor.darkGreen, width: 1.5)),
                  ); else
                  return ActionChip(
                    ...
                    avatar: CircleAvatar(
                      ...
                      child: Icon(type == ElementsTypes.GenreTags ? Icons.label_outline : Icons.info_outline, color: GlobalsColor.darkGreen),
                    ),
