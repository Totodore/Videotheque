...
import 'package:Videotheque/controllers/tv_controller/carrousel_controller.dart';

class CarrouselView extends StatelessWidget {
  ElementsTypes type;
  List dataCarrousel;
  Function showSeasonEl;
  CarrouselView(this.type, this.dataCarrousel, [this.showSeasonEl]);
  
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => CarrouselController(context, type, dataCarrousel, showSeasonEl),
